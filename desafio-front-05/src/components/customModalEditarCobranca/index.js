...
function ModalEditarCobranca() {
    ...
    const { setAbrirModalEditarCobranca, setAbrirModalAzulEditarCobranca } = useUser()
    ...
    async function cobrancaDados() {
        ...
        try {
            ...
            setData(new Date(response.data.data_vencimento).toISOString().slice(0, 10))
    ...
    async function handleSubmit(event) {
        ...
        try {
            ...
            const response = await api.put(`/cobranca/${idCobranca}`, {
                nome,
                descricao,
            ...
            setAbrirModalEditarCobranca(false)
            setAbrirModalAzulEditarCobranca(true)
                ...
                <div className="modal-content-criar-cobranca">
                    ...
                    <form className='form-modal-criar-cobrança'>
                        ...
                        <div className='div-botoes-modal-criar-cobranca'>
                            <button onClick={() => setAbrirModalEditarCobranca(false)} type='button' className='button-cancelar-modal-criar-cobranca'>Cancelar</button>
                    ...
                    <img onClick={() => setAbrirModalEditarCobranca(false)} className='x-modal-criar-cobranca' alt='x-icone' src={cancel}></img>
                </div>
            </div >
